...
$fulfilled_count = count(array_filter($assigned_orders, function ($o) {
...
<div class="wrap polar-dashboard polar-distributor-dashboard">
    ...
    <div class="polar-stats-grid">
        ...
        <div class="polar-stat-card stat-card-success">
            ...
            <div class="stat-card-content">
                <h3 class="stat-card-value"><?php echo esc_html($fulfilled_count); ?></h3>
                <p class="stat-card-label"><?php esc_html_e('Fulfilled', 'pexpress'); ?></p>
            </div>
        </div>
    </div>
